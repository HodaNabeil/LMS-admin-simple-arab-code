  ...
  return (
    <aside className="w-64 h-screen overflow-y-auto cairo-font bg-white border-r border-gray-100 shadow-xl flex flex-col">
      ...
      <div className="flex items-center gap-3 h-20 px-6 border-b border-gray-100 mb-2">
        ...
        />
        <span className="font-bold text-base text-gray-800 cairo-font">
          محمد محمد
        </span>
      </div>
      <div className="flex-1 p-2">
        <Accordion type="single" collapsible className="space-y-1 bg-white">
          {sidebarData.map((section, index) => (
            ...
            >
              <AccordionTrigger
                className={`flex items-center gap-2 px-3 py-2 text-gray-700 hover:bg-blue-50 rounded-lg text-base font-semibold transition-all ${
                ...
                onClick={() =>
                  setActiveSection(
                    activeSection === index.toString() ? null : index.toString()
                  )
                }
              >
                <span
                        ...
                        <li
                          ...
                          className={`flex items-center gap-3 px-4 py-2 rounded-xl cursor-pointer text-sm font-medium transition-all ${
                            isActive
                              ...
                              : "text-gray-500 hover:text-[#2563eb] hover:bg-[#e0edff]"
                          }`}
                          onClick={() => {
