...
export default function FormOrder({
  ...
  const handleSelectChange = (field: keyof OrderFormData, value: unknown) => {
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
    ...
    <form className="w-full" onSubmit={handleSubmit}>
      <div className="grid gap-4">
        ...
        <div className="grid gap-3">
          <label htmlFor="price" className="font-bold text-gray-900 mb-1">
            السعر (بالسنت)
          </label>
          <Input
            id="price"
        ...
        {/* Order Status */}
        <div className="grid gap-3">
          <label htmlFor="orderStatus" className="font-bold text-gray-900 mb-1">
            حالة الطلب
          </label>
          <Select
            inputId="orderStatus"
        ...
        <div className="grid gap-3">
          ...
          <Select
            ...
            onChange={(value) =>
              handleSelectChange('courses', value as OptionType[])
            }
            isDisabled={isLoading}
            classNamePrefix="react-select"
            styles={selectStyles}
