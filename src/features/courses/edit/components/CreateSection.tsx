        ...
        <div className="flex items-center gap-2 mb-4 ">
          ...
          <Button
            ...
            onClick={() => {
              ...
              dispatch({
                type: "SET_SHOW_DELETE_SECTION_MODAL",
                payload: true,
              });
            }}
            ...
            <div className="flex items-center gap-2 ">
              ...
              {state.editingLessonId === lesson.id ? (
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter")
                      handleSaveEditLesson(section.id, lesson.id);
                  }}
                  autoFocus
                />
              ) : (
              ...
              <Button
                ...
                onClick={() =>
                  dispatch({
                    ...
                    payload: { sectionId: section.id, lessonId: lesson.id },
                  })
                }
              >
        ...
        <div className="flex items-center gap-2 mt-2 ">
          <Button
            ...
            onClick={() => {
              dispatch({
                type: "SET_SHOW_LESSON_MODAL",
                payload: { sectionId: section.id, mode: "add" },
              });
